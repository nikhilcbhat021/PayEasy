...
export const PersonIcon = ({strokeWidth = 2}: IconPropsType) => { return <svg xmlns="http://www.w3.org/2000/svg" 
    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className="text-amber-700 lucide size-5 lucide-user-round-search-icon lucide-user-round-search">
